      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <Tabs defaultValue="inserview" className="w-full">
          <TabsList className="grid w-full grid-cols-2 mb-8">
            <TabsTrigger value="inserview">Inserview Studio</TabsTrigger>
            <TabsTrigger value="job-clipper">Job Clipper</TabsTrigger>
          </TabsList>
          
          {/* Inserview Studio Privacy Policy */}
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="ml-4">
                      ...
                      <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                        <li>확장 프로그램 삭제: 브라우저에서 확장 프로그램을 삭제하면 기기에 저���된 모든 데이터가 즉시 삭제됩니다.</li>
